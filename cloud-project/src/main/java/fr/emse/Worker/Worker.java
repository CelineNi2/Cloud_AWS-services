...
public class Worker{
	...
	public static void main(String[] args) {
		...
		treatMessages(queueURL, sqsClient);
	}
	
	private static void treatMessages(String queueURL, SqsClient sqsClient) {
		Region region = Region.US_EAST_1;
    ...
    private static void updateDailyFile(S3Client s3, String bucketName, List<S3Object> objects, String dailyName, 
        ...
        if (!header.contains(head[1])) {
            ...
            System.out.println("This data doesn't need to be uploaded.");
        }
    }
